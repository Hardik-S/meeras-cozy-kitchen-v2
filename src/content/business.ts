export const business = {
  name: "Meera's Cozy Kitchen",
  shortName: "Meera's",
  location: "Brampton, Ontario",
  serviceArea: "Brampton pickup with details shared after booking",
  ...
  allergenNotice:
    "Prepared in a home kitchen that may handle common allergens including wheat, milk, eggs, soy, peanuts, tree nuts, and sesame.",
  noticeCopy:
